...
function renderVillage() {
    ...
    echo("<a href='oldindex.php?action=upgradeHQ'>upgrade HQ</a>");
...
function showLoginForm(){
    ...
    <div class="container login">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="oldindex.php" method="post" name="login">
...
function showLogoutForm(){
    ?>
    <div class="btn-group" role="group">
        <form action="oldindex.php" method="post" name="logout">
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form action="oldindex.php" method="get" name="logout">
                        <input type="hidden" name="action" value="logout" />
                        <input type="submit" class="btn btn-error" value="Logout" />
                    </form>
                </div>
...
function showRegistrationForm(){
    ...
    <div class="container logout">
        <div class="panel panel-default">
            <div class="panel-heading">Login</div>
            <div class="panel-body">
                <form action="oldindex.php" method="post" name="register">
                    <div class="input-group">
                        <span class="input-group-addon" id="basic-addon1">U</span>
                        <?php
